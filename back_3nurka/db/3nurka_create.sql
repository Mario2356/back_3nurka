...
ALTER TABLE address ADD CONSTRAINT address_city_area
...
ALTER TABLE address ADD CONSTRAINT address_order
...
ALTER TABLE bike ADD CONSTRAINT bike_order
    FOREIGN KEY (order_id)
        REFERENCES "order" (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE repairs ADD CONSTRAINT repairs_bike
    FOREIGN KEY (bike_id)
        REFERENCES bike (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE storage ADD CONSTRAINT storage_bike
    FOREIGN KEY (bike_id)
        REFERENCES bike (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
